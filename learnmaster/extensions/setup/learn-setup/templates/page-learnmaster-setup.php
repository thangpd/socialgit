...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/libs/select2/css/select2.min.css">
    <link rel="stylesheet" href="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/libs/jquery-ui-1.11.4/jquery-ui.min.css">
     <link rel="stylesheet" href="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/fonts/icon-font/flaticon.css">
    <link rel="stylesheet" href="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/css/setup-wizard.css">
</head>
<body>
	<div class="la-setup">
		<h1 class="la-logo">
			<a href="#" class="link">
				<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/example-logo.png" alt="" class="la-pic" />
			</a>
		</h1>
		<div class="well" >
		    <div class="wizard">
		    	<div class="rb-logo-bar">
		    		<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/example-logo.png" alt="" class="rb-pic">
		    	</div>
		            ...
		            <div class="step-content" id="step-3">
	                    ...
	                    <div class="rb-demo-list">
	                    	<div class="item">
	                    		<div class="inner">
	                    			<div class="pic">
	                    				<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/temp/post-1.jpg" alt="" class="rb-pic">
	                    			</div>
	                    			<div class="desc">
	                    	...
	                    	<div class="item">
	                    		<div class="inner">
	                    			<div class="pic">
	                    				<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/temp/post-3.jpg" alt="" class="rb-pic">
	                    			</div>
	                    			<div class="desc">
	                    				<h4 class="title">Example title</h4>
	                    				<span>Lorem ipsum dolor sit amet consectetur</span>
	                    	...
	                    	<div class="item">
	                    		<div class="inner">
	                    			<div class="pic">
	                    				<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/temp/post-4.jpg" alt="" class="rb-pic">
	                    			</div>
	                    			<div class="desc">
	                    				<h4 class="title">Example title</h4>
	                    				<span>Lorem ipsum dolor sit amet consectetur</span>
	                    	...
	                    	<div class="item">
	                    		<div class="inner">
	                    			<div class="pic">
	                    				<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/temp/post-5.jpg" alt="" class="rb-pic">
	                    			</div>
	                    			<div class="desc">
	                    				<h4 class="title">Example title</h4>
	                    				<span>Lorem ipsum dolor sit amet consectetur</span>
	                    	...
	                    	<div class="item">
	                    		<div class="inner">
	                    			<div class="pic">
	                    				<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/temp/post-8.jpg" alt="" class="rb-pic">
	                    			</div>
	                    			<div class="desc">
	                    				<h4 class="title">Example title</h4>
	                    				<span>Lorem ipsum dolor sit amet consectetur</span>
	                    	...
	                    	<div class="item">
	                    		<div class="inner">
	                    			<div class="pic">
	                    				<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/temp/post-10.jpg" alt="" class="rb-pic">
	                    			</div>
	                    			<div class="desc">
	                    				<h4 class="title">Example title</h4>
	                    				<span>Lorem ipsum dolor sit amet consectetur</span>
	                    	...
	                    	<div class="item">
	                    		<div class="inner">
	                    			<div class="pic">
	                    				<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/temp/post-28.jpg" alt="" class="rb-pic">
	                    			</div>
	                    			<div class="desc">
	                    				<h4 class="title">Example title</h4>
	                    				<span>Lorem ipsum dolor sit amet consectetur</span>
	                    	...
	                    	<div class="item">
	                    		<div class="inner">
	                    			<div class="pic">
	                    				<img src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/images/temp/post-44.jpg" alt="" class="rb-pic">
	                    			</div>
	                    			<div class="desc">
	                    				<h4 class="title">Example title</h4>
	                    				<span>Lorem ipsum dolor sit amet consectetur</span>
	...
	<script type="text/javascript" src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/libs/jquery-3.2.1.min.js"></script>
	<script type="text/javascript" src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/libs/jquery-ui-1.11.4/jquery-ui.min.js"></script>
	<script type="text/javascript" src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/libs/select2/js/select2.min.js"></script>
	<script type="text/javascript" src="http://localhost/flare/wp-content/plugins/learnmaster/extensions/setup/learn-setup/templates/assets/js/learnmaster-wizard.js"></script>
</body>
</html>