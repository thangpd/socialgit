...
;(function ($, lema) {
    "use strict";
    var bundleList = window.bundleList || {};

    // Dropdown list

    bundleList.shortcode_ajax = function () {
    ...
    lema.shortcodes.register('lema_bundle_list', {
        run: function () {
            $.each(bundleList, function (index, value) {
                value();
            });
            lema.log("Lema bundle list is running");
        }
    });
})(jQuery, lema);