...
class CourseImageShortcode extends Shortcode
{
    const SHORTCODE_ID          =  'lema_coursecard_image';
...
//    	echo '</pre>';
    ...
    function setHtmlOptionDefault() {
        ...
        */
        $option = array(
                        'block'         => '<div class="course-image-wrapper %1$s">
                                                %2$s
                                                %3$s
                                                %4$s
                                                %5$s
                        ...
                        'hours'         => '<div class="lema-hours">%1$s</div>',
